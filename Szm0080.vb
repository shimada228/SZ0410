...
Module SZM0080BAS
	...
	Public Structure SZM0080_S
		...
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		<VBFixedString(4),System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray,SizeConst:=4)> Public s_code() As Char '小分類コード
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
		<VBFixedString(20),System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray,SizeConst:=20)> Public s_name() As Char '名称
		'UPGRADE_WARNING: 固定長文字列のサイズはバッファに合わせる必要があります。 詳細については、'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="3C1E4426-0B80-443E-B943-0627CD55D48B"' をクリックしてください。
	...
	Structure SZM0080_KEY0_S
		...
		<VBFixedString(4),System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.ByValArray,SizeConst:=4)> Public s_code() As Char '小分類コード
	End Structure
	Public SZM0080_BUF0 As SZM0080_KEY0_S
	
	
	'　データバッファー
	Public SZM0080_KEY0 As Short
	Public SZM0080 As SZM0080_S
	Public SZM0080OPENSW As Short
	Public SZM0080INVSW As Short
	
	'　ＲＤＯ関連オブジェクト
	Public SZM0080RS As RDO.rdoResultset
	Public SZM0080INS As RDO.rdoQuery
	Public SZM0080UPD As RDO.rdoQuery
	Public SZM0080DEL As RDO.rdoQuery
	Public SZM0080RSSW As String
	Public SZM0080_FILE As FILNAME_S
End Module